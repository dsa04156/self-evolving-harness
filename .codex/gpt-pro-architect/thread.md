...
- oracle latest session id: self-evolving-harness-gate2-packet (failed before transmission)
- oracle session ids: self-evolving-harness-gate1-fresh, self-evolving-harness-gate1-packet-2, self-evolving-harness-gate1-packet-3, self-evolving-harness-gate1-packet-4, self-evolving-harness-gate2-packet
...
- last reuse preflight: Gate 2 Oracle dry-run positively named the recorded endpoint/tab and no launch;
  the live Oracle attach failed before transmission because the pre-existing Chrome lacked Oracle
  attach metadata. A manual direct-CDP fallback then verified the exact target and URL, empty composer,
...
- model evidence: Oracle 0.16.1; Gate 2 requested and dry-run resolved browser `gpt-5-pro`; manual
